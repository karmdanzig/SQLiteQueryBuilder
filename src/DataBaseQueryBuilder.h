...
public:
    ...
    DataBaseQueryBuilder& Update(const string& table);
    ...
    DataBaseQueryBuilder& WhereEqual(const string& filterField, const int& value);

    DataBaseQueryBuilder& WhereLessThan(const string& filterField, const int& value);

    DataBaseQueryBuilder& WhereGreaterThan(const string& filterField, const int& value);

    DataBaseQueryBuilder& WhereEqualOrLessThan(const string& filterField, const int& value);

    DataBaseQueryBuilder& WhereEqualOrGreaterThan(const string& filterField, const int& value);
...
private:
    ...
    void insertFromListWithSeparator(const vector<string>& whichlist, const string& separator);
    void insertFromListWithOperatorList(const vector<string>& whichList);
};
