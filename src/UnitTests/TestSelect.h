...
TEST(Select, TEST_BASIC_SELECT_WITH_ALIAS)
{
    string query = SelectBuilder().
            Select("Column").
            FromAs("Table1", "T1").
...
TEST(Select, TEST_BASIC_SELECT_WITH_ALIAS_AND_TWO_CONDITIONS)
{
    string query = SelectBuilder().
            Select("Column").
            FromAs("Table1", "T1").
...
TEST(Select, TEST_BASIC_SELECT_WITH_TWO_ALIAS_AND_TWO_CONDITIONS)
{
    string query = SelectBuilder().
            Select("Column").
            FromAs("Table1", "T1").
...
TEST(Select, TEST_BASIC_SELECT_WITH_TWO_ALIAS_AND_TWO_CONDITIONS_WITH_WHERE_CLAUSE)
{
    string query = SelectBuilder().
            Select("Column").
            FromAs("Table1", "T1").
...
TEST(Select, TEST_BASIC_SELECT_WITH_THREE_ALIAS_AND_THREE_CONDITIONS_WITH_WHERE_CLAUSE)
{
    string query = SelectBuilder().
            Select("Column").
            FromAs("Table1", "T1").
...
TEST(Select, TEST_BASIC_SELECT_NATURAL_JOIN)
{
	string query = SelectBuilder().
			Select("Column").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_CROSS_JOIN)
{
	string query = SelectBuilder().
			Select("Column").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_NATURAL_OUTER_JOIN)
{
	string query = SelectBuilder().
			Select("Column").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_ALL)
{
	string query = SelectBuilder().
			SelectAll().
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_DISTINCT)
{
	string query = SelectBuilder().
			Select("Column").
			Distinct().
...
TEST(Select, TEST_BASIC_SELECT_DISTINCT_ALL)
{
	string query = SelectBuilder().
			SelectAll().
			Distinct().
...
TEST(Select, TEST_BASIC_SELECT_WITH_ONE_INTEGER_CONDITION)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_WHERE_IN_WITH_ONE_ELEMENT)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_WHERE_IN_WITH_TWO_ELEMENTS)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_WHERE_IN_WITH_FIVE_ELEMENTS)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_ONE_SUBQUERY)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_ONE_TEXT_CONDITION)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_ONE_TEXT_LIKE_CONDITION)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_ONE_TEXT_NOT_LIKE_CONDITION)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_MULTIPLE_CONDITIONS_AND_CLAUSE)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_MULTIPLE_CONDITIONS_OR_CLAUSE)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_MULTIPLE_CONDITIONS_AND_OR_CLAUSE)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_BETWEEN_CLAUSE)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_NOT_BETWEEN_CLAUSE)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_GROUP_BY)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_GROUP_BY_AND_HAVING)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_GROUP_BY_AND_ORDER_BY)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_GROUP_BY_AND_ORDER_BY_ASC)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
...
TEST(Select, TEST_BASIC_SELECT_WITH_GROUP_BY_AND_ORDER_BY_DESC)
{
	string query = SelectBuilder().
			Select("Column1").
			From("Table").
